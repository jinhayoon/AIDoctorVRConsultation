...
namespace CrazyMinnow.SALSA.OneClicks
{
	...
	/// RELEASE NOTES:
	///		2.7.2.2 (2025-09-25):
	///			! Added error trapping to emoter frac and silence analyzer settings adjustments
	///				sections.
	///		2.7.2.1 (2024-10-17):
	///			~ SMR search expanded for CC4 facial hair options.
	///		2.7.2 (2023-09-28):
	...
	///			~ Modified shape choices and values to provide better dynamics for
